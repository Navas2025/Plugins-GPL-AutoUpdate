...
add_filter('upgrader_pre_download', function($reply, $package, $upgrader) {
    ...
    // Solo interceptar URLs de wpamelia.com o store.melograno.io
    if (!empty($package) && (strpos($package, 'wpamelia.com') !== false || strpos($package, 'store.melograno.io') !== false)) {
        
        error_log('⚠️ URL de Amelia detectada, procediendo a reemplazar...');
        ...
        error_log('ℹ️ URL no requiere reemplazo (no es de Amelia)');
    }
