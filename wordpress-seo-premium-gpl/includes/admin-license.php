...
add_action('admin_menu', function() {
    if (current_user_can('manage_options')) {
        add_options_page(
            __('Licencia Yoast SEO Premium','wordpress-seo-premium-gpl'), 
            __('Licencia Yoast SEO Premium','wordpress-seo-premium-gpl'), 
            'manage_options', 
...
function yoast_seo_gpl_license_page() { 
    ...
    $expiry_date = get_option('yoast_seo_gpl_expiry','');
    ...
    $nonce = wp_create_nonce('yoast_seo_gpl_nonce');

    ?>
    <div class="wrap">
        <div class="yoast-seo-gpl-container">
            <h1><?php echo esc_html(__('Licencia Yoast SEO Premium','wordpress-seo-premium-gpl')); ?></h1>
            ...
            <?php if ($is_active): ?>
                ...
                <div class="yoast-seo-license-status yoast-seo-license-active">
                    ...
                    <h2 class="status-title"><?php echo esc_html(__('Su API Key está ACTIVA.','wordpress-seo-premium-gpl')); ?></h2>
            ...
            <?php elseif ($status === 'expired'): ?>
                ...
                <div class="yoast-seo-license-status yoast-seo-license-inactive" style="border-left: 5px solid #ffba00; background-color: #fffbe6;">
                    ...
                    <h2 class="status-title"><?php echo esc_html(__('Su API Key ha CADUCADO.','wordpress-seo-premium-gpl')); ?></h2>
            ...
            <?php else: ?>
                ...
                <div class="yoast-seo-license-status yoast-seo-license-inactive">
                    <div class="status-icon">❌</div>
                    <h2 class="status-title"><?php echo esc_html(__('Su API Key está INACTIVA.','wordpress-seo-premium-gpl')); ?></h2>
                    <p class="description-text"><?php echo esc_html(__('Introduzca su API Key para activar las actualizaciones automáticas.','wordpress-seo-premium-gpl')); ?></p>
    ...
    <style>
        .yoast-seo-gpl-container { max-width: 650px; margin: 0 auto; padding-top: 20px; text-align: center; }
        .yoast-seo-license-status { padding: 30px; border-radius: 8px; margin-top: 30px; box-shadow: 0 4px 12px rgba(0,0,0,.08); border: 1px solid #eee; text-align: left; }
        ...
        .yoast-seo-license-active { border-left: 5px solid #46b450; background-color: #f9fff9; }
        .yoast-seo-license-inactive { border-left: 5px solid #dc3232; background-color: #fff9f9; }
        .yoast-seo-license-status p { margin: 10px 0; line-height: 1.6; }
        .yoast-seo-license-status p strong { display: inline-block; min-width: 150px; font-weight: 700; color: #333; }
        .yoast-seo-license-warning { color: #d8a002; font-weight: 600; background-color: #fffbe6; padding: 8px; border-radius: 4px; border: 1px solid #d8a00230; margin-top: 15px; }
        #yoast-seo-gpl-license-form { margin-top: 25px; margin-bottom: 20px; display: flex; flex-direction: column; gap: 10px; align-items: center; }
    ...
    (function(){
        ...
        function validateKey() {
            ...
            formData.append('action', 'yoast_seo_gpl_validate_key');
        ...
        function deactivateKey() {
            ...
            const formData = new URLSearchParams();
            formData.append('action', 'yoast_seo_gpl_deactivate_key');
            formData.append('security', nonce);
