...
class LNC_Update_Checker {
     ...
     * SOLO muestra avisos si la versión instalada es menor que la disponible
     */
    public static function show_update_notices() {
        ...
        foreach ( $updates as $update ) {
            ...
            foreach ( $installed_plugins as $plugin_file => $plugin_data ) {
                ...
                // Si encontramos el plugin, guardar su versión
            ...
            // SOLO mostrar si: el plugin está instalado Y versión instalada < versión nueva
            if ( $installed_version && version_compare( $installed_version, $new_version, '<' ) ) {
                $updates_to_show[] = $update;
            }
        }
        
        // Si no hay actualizaciones relevantes después del filtro, no mostrar nada
